...
// S-Class 3D Model - Optimized
const SClassModel = () => {
  // Preload the model inside the component for better control
  useGLTF.preload('/Mercedes_S_class/scene.gltf');

  const { scene } = useGLTF('/Mercedes_S_class/scene.gltf');
...
const MercedesSClass = () => {
  ...
  const fallbackImage = "https://images.unsplash.com/photo-1563720223185-11003d516935?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80";
